...
# 화면 타이틀 설정
pygame.display.set_caption("로켓단 피하기")
...
enemy_x_pos = random.randint(0, screen_width - enemy_width) # 가로 위치 랜덤으로 설정
enemy_y_pos = -enemy_height # 세로 위치를 화면 위쪽으로 설정
enemy_speed = 10 # 적 캐릭터 이동 속도 정의
